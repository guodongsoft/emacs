...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (moe-theme ample-theme evil-magit magit-gitflow autopair auto-compile company company-web company-ycmd magit js-comint neotree rspec-mode xwidgete ctags-update projectile-speedbar egg git-command package-utils emmet-mode mozc evil)))
